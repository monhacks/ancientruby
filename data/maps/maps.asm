...
MapGroup_Littleroot:
	...
	map OldaleMart, TILESET_MART, INDOOR, OLDALE_TOWN, MUSIC_POKEMON_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PetalburgMart, TILESET_MART, INDOOR, PETALBURG_CITY, MUSIC_POKEMON_MART, FALSE, PALETTE_DAY, FISHGROUP_SHORE
